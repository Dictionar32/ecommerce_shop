...
export namespace PaymentApiContract {
  // ==============================
  // ENUMS
  // ==============================
  ...
  // VALIDATORS
  // ==============================
  export const validateResponse = (payload: unknown): Response =>
    Schema.parse(payload)

  export const validateIndex = (payload: unknown): Index =>
    IndexSchema.parse(payload)

  export const validateCreate = (payload: unknown): Create =>
