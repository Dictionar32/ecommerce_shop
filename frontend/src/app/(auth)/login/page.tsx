    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 bg-obsidian-950">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="mb-8">
            <h1 className="font-heading text-3xl text-obsidian-50">Masuk</h1>
            <p className="text-obsidian-500 text-sm mt-1">Selamat datang kembali</p>
          </div>
              ...
              <FormField name="password" control={form.control} render={({ field }) => (
                <FormItem>
                  ...
                  <div className="text-right mt-1">
                    <Link href="/forgot-password" className="text-xs text-gold-600 hover:text-gold-400 transition-colors">
                      Lupa password?
                    </Link>
                  </div>
                  <FormMessage />
