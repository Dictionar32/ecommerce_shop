...
export const toApiProdukReviewsCreate = (form: ApiFormValues['ProdukReviewsCreate']): ProdukReviewsCreatePayload => ({
  [ApiApiField.RATING]: form.rating,
  [ApiApiField.TITLE]: form.title,
  [ApiApiField.COMMENT]: form.comment,
})

export const toApiProfileUpdate = (form: ApiFormValues['ProfileUpdate']): ProfileUpdatePayload => ({
  [ApiApiField.NAME]: form.name,
  [ApiApiField.EMAIL]: form.email,
})
...
export const toApiPaymentCreate = (form: ApiFormValues['PaymentCreate']): PaymentCreatePayload => ({
