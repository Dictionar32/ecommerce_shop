...
export namespace OrderApiContract {
...
export const validateIndex = (payload: unknown) => IndexSchema.parse(payload);
export const validateSchema = (payload: unknown) => Schema.parse(payload);
export const validateCreate = (payload: unknown) => CreateSchema.parse(payload)
}
